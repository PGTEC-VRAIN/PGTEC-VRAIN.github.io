...
- Verifiable Credentials and EUDI Wallet: Verifiable credentials that comply with European standards and the European wallet are used for storage to ensure total security in the data space. Each participant will have credentials with which to interact with the other participants. This ensures a reliable data space. 

- Cloud Services: The data space is designed to be in the cloud using Amazon Web Services. The project has the collaboration of the companies ![Kanzo-Tech](https://kanzo.site/) and ![Think-IT](https://think-it.io/) to carry out the migration to the cloud.
...
- ![Agencia Estatal de Meteoroloǵia (AEMET)](https://www.aemet.es/es/portada)
- ![Sistema de Información Agrocmlimática para el Regadío (SiAR)](https://servicio.mapa.gob.es/websiar/)
- ![Confedereación Hidrográfica del Júcar (CHJ)](https://www.chj.es/es-es/Paginas/Home.aspx)
- ![Agencia Valenciana de Meteorología (AVAMET)](https://www.avamet.org/mxo-meteoxarxaonline.html)
...
<p align="center">
  <img src="welcome/images/dana.png" width="560">
</p>
