...
- **Smart Data Models:** Data schemas used to create a common ontology to standardise all data in the data space following the JSON-LD format. For more information go to the  [Smart Data Models section](/docs/SmartDataModels/index.md).
